...
select 
  ...
  'paw' as icon,
  '/' as link,
  JSON('[{"link":"/","title":"Manual Count Form","active":true},{"link":"/reports.sql","title":"Reports","active":false},{"link":"/monitor.sql","title":"DMS Monitoring","active":false}]') as menu_item,
  TRUE as sidebar,
